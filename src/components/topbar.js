        ...
        <div className="TopBar">
            <div className="p-2 max-w-full mx-auto bg-white rounded-sm border-indigo-800 border-b shadow-md justify-between flex items-center gap-2 space-x-0">
                ...
                <div className="gap 2">
                    ...
                    { loggedIn? (<Link to="/account"><button className="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold mx-2 py-2 px-4 rounded-full" styles="background: url('../img/acc.sv') top-left">{name}</button> </Link>) : null}
                </div>
            </div>
